...
Для начала игры, напишите боту /квиз в чате. Всем игрокам будет предоставлено 30 секунд для подключения к текущей игре. После этого, бот начнет квиз, отправляя вопросы с вариантами ответа. Вам нужно написать номер правильного ответа в сообщении. Если ваш вариант ответа является верным, то бот подтвердит верный ответ и отправит следующий вопрос. Если верных ответов не было дано, то следующий вопрос будет отправлен по таймауту. Считается только первый данный ответ.
Хорошей игры!`)
}
